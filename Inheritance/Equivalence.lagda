...
The following lemmas establish significant facts about the relationship
between the denotational semantics and the intermediate semantics.
The Agda proofs exhibit the equational reasoning steps of the original proofs in CP89.
...
The restriction to the class child c κ ensures that it is not the root class;
